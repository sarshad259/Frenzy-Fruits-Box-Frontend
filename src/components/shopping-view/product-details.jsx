  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogClose}>
      <DialogContent className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-2 sm:p-4 md:p-8 max-w-[98vw] md:max-w-[90vw] lg:max-w-[70vw] bg-card rounded-2xl shadow-2xl animate-fade-in-up transition-all duration-300">
        ...
        {/* Responsive right column: close button always visible, only content scrolls */}
        <div className="flex flex-col justify-between w-full max-w-2xl mx-auto relative">
          {/* Add a spacer for the close button on mobile */}
          <div className="h-10 md:hidden" />
          {/* Scrollable content area, with margin to avoid close button overlap */}
          <div className="overflow-y-auto max-h-[60vh] md:max-h-[70vh] mt-2">
            <div>
            ...
            <div className="max-h-[200px] overflow-auto animate-fade-in delay-600 mt-4">
